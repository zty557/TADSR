...
class UNetMidBlock2D(nn.Module):
    ...
    def __init__(
        ...
        if attn_groups is None:
            attn_groups = resnet_groups if resnet_time_scale_shift == "default" or encoder_resnet else None
...
class DownEncoderBlock2D(nn.Module):
    ...
    def forward(self, hidden_states: torch.FloatTensor, scale: float = 1.0, temb=None) -> torch.FloatTensor:
        for resnet in self.resnets:
